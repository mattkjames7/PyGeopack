...
docker exec -u ubuntu "${CONTAINER}" bash -c "cd /home/ubuntu/PyGeopack && source /home/ubuntu/env/bin/activate && python3 setup.py bdist_wheel"
...
docker exec -u ubuntu "${CONTAINER}" bash -c "source /home/ubuntu/env/bin/activate && python3 /home/ubuntu/test_run.py"
