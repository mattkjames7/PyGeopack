import numpy as np
from ._CFunctions import _CSMtoGEOUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def SMtoGEO(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian SM to GEO coordinates.
	...
	_CSMtoGEOUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
