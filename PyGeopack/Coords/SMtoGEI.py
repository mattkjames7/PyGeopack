import numpy as np
from ._CFunctions import _CSMtoGEIUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def SMtoGEI(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian SM to GEI coordinates.
	...
	_CSMtoGEIUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
