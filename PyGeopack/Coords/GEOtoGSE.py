import numpy as np
from ._CFunctions import _CGEOtoGSEUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def GEOtoGSE(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GEO to GSE coordinates.
	...
	_CGEOtoGSEUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
