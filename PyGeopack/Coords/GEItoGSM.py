import numpy as np
from ._CFunctions import _CGEItoGSMUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def GEItoGSM(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GEI to GSM coordinates.
	...
	_CGEItoGSMUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
