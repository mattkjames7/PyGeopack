import numpy as np
from ._CFunctions import _CGSEtoGEIUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def GSEtoGEI(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GSE to GEI coordinates.
	...
	_CGSEtoGEIUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
