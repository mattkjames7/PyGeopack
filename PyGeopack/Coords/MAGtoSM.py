import numpy as np
from ._CFunctions import _CMAGtoSMUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def MAGtoSM(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian MAG to SM coordinates.
	...
	_CMAGtoSMUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
