import numpy as np
from ._CFunctions import _CGEItoGSEUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def GEItoGSE(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GEI to GSE coordinates.
	...
	_CGEItoGSEUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
