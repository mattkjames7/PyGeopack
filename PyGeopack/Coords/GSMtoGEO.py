import numpy as np
from ._CFunctions import _CGSMtoGEOUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def GSMtoGEO(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GSM to GEO coordinates.
	...
	_CGSMtoGEOUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
