import numpy as np
from ._CFunctions import _CMAGtoGSMUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def MAGtoGSM(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian MAG to GSM coordinates.
	...
	_CMAGtoGSMUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
