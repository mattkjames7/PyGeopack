import numpy as np
from ._CFunctions import _CGSMtoGEIUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def GSMtoGEI(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GSM to GEI coordinates.
	...
	_CGSMtoGEIUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
