import numpy as np
from ._CFunctions import _CGEOtoGEIUT
from ..ct import ctInt,ctIntPtr,ctFloatPtr,ctDoublePtr



def GEOtoGEI(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GEO to GEI coordinates.
	...
	_CGEOtoGEIUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _Date, _ut, _Xout, _Yout, _Zout)
