...
_CGSEtoGSMUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CGSEtoGSMUT.restype = None

_CGSMtoGSEUT = libgeopack.GSMtoGSEUT
_CGSMtoGSEUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CGSMtoGSEUT.restype = None

_CGSMtoSMUT = libgeopack.GSMtoSMUT
_CGSMtoSMUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CGSMtoSMUT.restype = None

_CSMtoGSMUT = libgeopack.SMtoGSMUT
_CSMtoGSMUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CSMtoGSMUT.restype = None

_CGSEtoSMUT = libgeopack.GSEtoSMUT
_CGSEtoSMUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CGSEtoSMUT.restype = None

_CGSEtoMAGUT = libgeopack.GSEtoMAGUT
_CGSEtoMAGUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CGSEtoMAGUT.restype = None

_CSMtoGSEUT = libgeopack.SMtoGSEUT
_CSMtoGSEUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CSMtoGSEUT.restype = None

_CMAGtoGSEUT = libgeopack.MAGtoGSEUT
_CMAGtoGSEUT.argtypes = [dptr, dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr, dptr]
_CMAGtoGSEUT.restype = None

_CMLONtoMLTUT = libgeopack.MLONtoMLTUT
_CMLONtoMLTUT.argtypes = [dptr, ct.c_int, ct.c_int, ct.c_float, dptr]
_CMLONtoMLTUT.restype = None

_CMLTtoMLONUT = libgeopack.MLTtoMLONUT
_CMLTtoMLONUT.argtypes = [dptr, ct.c_int, ct.c_int, ct.c_float, dptr]
_CMLTtoMLONUT.restype = None

_CGEOtoMAGUT = libgeopack.GEOtoMAGUT
_CGEOtoMAGUT.argtypes = [dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr]
_CGEOtoMAGUT.restype = None

_CMAGtoGEOUT = libgeopack.MAGtoGEOUT
_CMAGtoGEOUT.argtypes = [dptr, dptr, ct.c_int, ct.c_int, ct.c_float, dptr, dptr]
