...
double _A01[] = {    -116.53,    -55.553,    -101.34,    -181.69,    -436.54,    -707.77,    -1190.4};
double _A02[] = {     -10719,     -13198,     -13480,     -12320,      -9001,    -4471.9,     2749.9};
double _A03[] = {     42.375,     60.647,     111.35,     173.79,     323.66,     432.81,     742.56};
double _A04[] = {     59.753,     61.072,     12.386,    -96.664,    -410.08,    -435.51,    -1110.3};
double _A05[] = {     -11363,     -16064,     -24699,     -39051,     -50340,     -60400,     -77193};
double _A06[] = {     1.7844,     2.2534,     2.6459,     3.2633,     3.9932,     4.6229,     7.6727}; //C_06
...
double _A16[] = {     224.91,     55.047,    -298.32,     -514.1,    -867.03,    -424.23,    -2219.1};
double _A17[] = {    -9234.8,    -3875.7,     4400.9,      12482,      20652,     1100.2,      48253};
...
double _A24[] = {     14.468,     14.474,     14.288,     13.778,     13.729,     14.213,     11.123};
double _A25[] = {     32.177,     36.555,     33.822,     32.373,     28.353,     25.237,     21.558};
double _A26[] = {       0.01,       0.01,       0.01,       0.01,       0.01,       0.01,       0.01};
double _A27[] = {          0,          0,          0,          0,          0,          0,          0}; // 
double _A28[] = {     7.0459,     7.0787,     6.7442,     7.3195,     7.4237,     7.0037,     4.4518}; // x_0
double _A29[] = {          4,          4,          4,          4,          4,          4,          4}; // \gamma_T
double _A30[] = {         20,         20,         20,         20,         20,         20,         20}; // D_yc
