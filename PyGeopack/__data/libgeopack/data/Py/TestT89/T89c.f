...
c        WRITE(*,*) A(01),A(02),A(03),A(04),A(05)
c        WRITE(*,*) A(06),A(07),A(08),A(09),A(10)
       DYC=A(30)
       DYC2=DYC**2
       DX=A(18)
       HA02=0.5D0*A02
...
c        WRITE(*,*) DER(1,1),DER(2,1),DER(3,1)
c        WRITE(*,*) DER(1,2),DER(2,2),DER(3,2)
c        WRITE(*,*) DER(1,16),DER(2,16),DER(3,16)
c        WRITE(*,*) DER(1,17),DER(2,17),DER(3,17)
C
...
c       WRITE(*,*) DER(1,3),DER(2,3),DER(3,3)
c        WRITE(*,*) DER(1,4),DER(2,4),DER(3,4)
C
...
c        WRITE(*,*) BXT,BYT,BZT,AK1,AK2,AK16,AK17
