import numpy as np
from ._CFunctions import _CGSEtoGSMUT


def GSEtoGSM(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian GSE to GSM coordinates.
	...
	_CGSEtoGSMUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _date, _UT, _Xout, _Yout, _Zout)
