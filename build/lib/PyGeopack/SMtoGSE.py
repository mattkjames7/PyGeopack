import numpy as np
from ._CFunctions import _CSMtoGSEUT


def SMtoGSE(Xin, Yin, Zin, Date, ut, V=None):
	'''
	Converts from Cartesian SM to GSE coordinates.
	...
	_CSMtoGSEUT(_Xin, _Yin, _Zin, _n, _Vx, _Vy, _Vz, _date, _UT, _Xout, _Yout, _Zout)
