...
class TraceField(object):
	def __init__(self,Xin, Yin, Zin, Date, ut, Model='T96', CoordIn = 'GSM', CoordOut = 'GSM', alt=100.0, MaxLen=1000, DSMax=1.0,
				iopt=None,parmod=None,tilt=None,Vx=None,Vy=None,Vz=None,FlattenSingleTraces=True):
		...
		_CTraceField(_Xin, _Yin, _Zin, _n, _Date, _ut, _Model, _CoordIn, _CoordOut, _alt, _MaxLen, _DSMax, _Xout, _Yout, _Zout, _Bx, _By, _Bz, _nstep, _GlatN, _GlatS, _MlatN, _MlatS, _GlonN, _GlonS, _MlonN, _MlonS, _GltN, _GltS, _MltN, _MltS, _Lshell, _MltE, _FlLen)
...
class TraceFieldTimeSeries(object):
	def __init__(self,Xin, Yin, Zin, Date, ut, Model='T96', CoordIn = 'GSM', CoordOut = 'GSM', alt=100.0, MaxLen=1000, DSMax=1.0,
				iopt=None,parmod=None,tilt=None,Vx=None,Vy=None,Vz=None,FlattenSingleTraces=True,Verbose=True):
		...
		_CTraceFieldTimeSeries(_Xin, _Yin, _Zin, _n, _Date, _ut, _Model, _CoordIn, _CoordOut, _alt, _MaxLen, _DSMax, _Xout, _Yout, _Zout, _Bx, _By, _Bz, _nstep, _GlatN, _GlatS, _MlatN, _MlatS, _GlonN, _GlonS, _MlonN, _MlonS, _GltN, _GltS, _MltN, _MltS, _Lshell, _MltE, _FlLen, _Verb)
